...
I am aware of some bugs found during the final testing phases. Here is a list of the ones I know of:

*   **Bug a):** Loading between scenes. For example, going from the snow scene (intro) and then loading a save from the school. Doing this frequently can cause a memory dump, and the console will restart.
*   **Bug b):** Force-skipping dialogue that changes a sprite. There is a part where Misha changes her sprite while talking. If you skip quickly here... the sprite will not change.
*   **Bug c):** It is likely that the game will not work on OLD 3DS models. The game may fail to install due to Unity issues or the reduced RAM of these models, or there may be more unforeseen bugs. As I own a NEW model and do not have access to an OLD one, I cannot perform the relevant tests. If it happens to work, please ignore this point.

If you find any other bugs, please send me a DM on Reddit "u/Cratobeta_18" or post in the project's subreddit [**r/KatawaShoujo3DSPort**](https://www.reddit.com/r/KatawaShoujo3DSPort) so I can take note of it n.n
