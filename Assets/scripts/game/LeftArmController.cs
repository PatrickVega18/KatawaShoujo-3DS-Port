...
public class LeftArmController : MonoBehaviour
{
    ...
    public class SpriteSlot
    {
        ...
        public void Initialize(Vector3 basePosition, Vector2 baseSize)
        {
            ...
            if (mainImage != null)
            {
                ...
                LeftArmController.SetImageAlpha(mainImage, 0f); // Usar el método estático
            ...
            if (switchImage != null)
            {
                ...
                LeftArmController.SetImageAlpha(switchImage, 0f); // Usar el método estático
    ...
    private void ExecuteSpriteFadeOut(SpriteSlot slot, float duration)
    {
        ...
        Debug.Log("SpritesController: Acción 'fadeOut' iniciada para " + slot.slotName);
    }
    ...
    private Vector2 ParseTamano(string tamanoCsv, Vector2 defaultValue)
    {
        ...
        if (parts.Length == 2)
        {
            ...
            catch (System.Exception e)
            {
                ...
                if (defaultValue.x < 0.1f && defaultValue.y < 0.1f) { return new Vector2(128, 128); }
