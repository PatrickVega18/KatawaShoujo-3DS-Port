...
public class HeadsController : MonoBehaviour
{
    [System.Serializable]
    public class SpriteSlot
    {
        ...
        public void Initialize(Vector3 basePosition, Vector2 baseSize)
        {
            ...
            if (mainImage != null)
            {
                ...
                HeadsController.SetImageAlpha(mainImage, 0f); // Usar el método estático
            ...
            if (switchImage != null)
            {
                ...
                HeadsController.SetImageAlpha(switchImage, 0f); // Usar el método estático
    ...
    public bool SpriteAnimacionCompletada
    {
        get
        {
            if (allSlots == null) return true; // Protección ¬w¬
    ...
    private Vector2 ParseTamano(string tamanoCsv, Vector2 defaultValue)
    {
        ...
        if (parts.Length == 2)
        {
            ...
            catch (System.Exception e)
            {
                ...
                if (defaultValue.x < 0.1f && defaultValue.y < 0.1f) { return new Vector2(256, 256); }
